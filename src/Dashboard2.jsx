...
export default function Dashboard() {
  ...
  const distanceData = [
    { name: "5 กม.", value: runners.filter(r => r.distance === "5").length },
    { name: "10 กม.", value: runners.filter(r => r.distance === "10").length },
    { name: "21 กม.", value: runners.filter(r => r.distance === "21").length },
  ];
